...
public class PCConsumerController {
	...
	public  String   diplayTouristsReport(Map<String,Object> map)throws Exception{
		//consume   SpringRest Service/method/operation
		  ...
		  */
		  String serviceUrl="http://localhost:3030/SpringBootRestProj11-MiniProject-ExceptionHandler/pc/findAll";
		  ...
		  ObjectMapper mapper=new ObjectMapper();
		    List<PC> pcList=mapper.readValue(jsonRespBody, new TypeReference<List<PC>>() {	});
